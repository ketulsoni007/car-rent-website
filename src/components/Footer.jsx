            ...
            <Col lg="3" md="4" sm="6">
              <div className="mb-4">
                ...
                <p className="head__office">
                  233 Lane Street Gujarat,India
                </p>
                <p className="head__office">Phone: + 123 456 789 </p>
                <p className="head__office">Email: carrentforyou@gmail.com</p>
            ...
            <Col>
              <div className="footer__bottom">
                <p className="section__description pt-4 fw-bold text-center d-flex align-items-center justify-content-center gap-1">
                  <i className="ri-copyright-line"></i> From Anywhere
                  <span>Rent Car</span>. In India
                </p>
              </div>
            </Col>
          </Row>
